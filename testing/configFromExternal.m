function param = configFromExternal()
%% set this part
...
proj_root_dir = [getenv('HOME') '/MATLAB/convolutional-pose-machines-release/'];

% path of your caffe
caffepath = textread([proj_root_dir 'caffePath.cfg'], '%s', 'whitespace', '\n\t\b ');
...
param.model(1).caffemodel = [proj_root_dir 'model/_trained_MPI/pose_iter_985000_addLEEDS.caffemodel'];
param.model(1).deployFile = [proj_root_dir 'model/_trained_MPI/pose_deploy_centerMap.prototxt'];
...
param.model(2).caffemodel = [proj_root_dir 'model/_trained_MPI/pose_iter_630000.caffemodel'];
param.model(2).deployFile = [proj_root_dir 'model/_trained_MPI/pose_deploy_centerMap.prototxt'];
...
param.model(3).caffemodel = [proj_root_dir 'model/_trained_LEEDS_PC/pose_iter_395000.caffemodel'];
param.model(3).deployFile = [proj_root_dir 'model/_trained_LEEDS_PC/pose_deploy_centerMap.prototxt'];
...
param.model(4).caffemodel = [proj_root_dir 'model/_trained_FLIC/pose_iter_40000.caffemodel'];
param.model(4).deployFile = [proj_root_dir 'model/_trained_FLIC/pose_deploy.prototxt'];
